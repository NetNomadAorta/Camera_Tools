...
# User parameters
MOBILENET_TOGGLE = False
if MOBILENET_TOGGLE:
    SAVE_NAME      = "./Models-OD/Animals-MobileNet-0.model"
else:
    SAVE_NAME      = "./Models-OD/Animals-ResNet50-0.model"
USE_CHECKPOINT = True
...
NOISE_PROB          = 0.10  # Default: 0.05 
MOTION_BLUR_PROB    = 0.05  # Default: 0.05
ROTATION            = 20    # Default: 5
...
HORIZ_FLIP_CHANCE   = 0.25  # Default: 0.10
VERT_FLIP_CHANCE    = 0.25  # Default: 0.10
