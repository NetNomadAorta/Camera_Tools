...
OUTPUT_FOLDER = "Images/Screenshot_Images"  # Change this to the desired output folder
FRAMES_PER_SECOND = 0.25  # Change this to control how many frames to save per second
